...
function StartConv() {
	...
	const onSubmit = (event: any) => {
		...
		const config = {
            headers: {
                token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWQ0MiI6ImFtb250YXV0IiwiaWF0IjoxNjc4NDc4NDk5LCJleHAiOjE2Nzg1MTQ0OTl9.CW96cjbO-JeCbnLGCveXkIuflc4Wl33-SC6jY4zQI_8',
            },
        }
